const DOMAIN_NAME = "Plataforma de Talleres y Workshops E-Learning";
const itemName = "Desarrollo Web Avanzado";
const itemCategory = "E-Learning";
const itemQuantity = 45;
